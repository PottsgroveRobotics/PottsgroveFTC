...
public class PottsgroveTeleOp extends OpMode {
    ...
    public void loop() {
        ...
        motorLeftPower = (1/(motorLeftPower+robotYawSpeed))*(gamepad2.left_stick_x * robotYawSpeed - (motorLeftPower+robotYawSpeed))+1;
        motorRightPower = (1/(motorRightPower-robotYawSpeed))*(-gamepad2.left_stick_x * robotYawSpeed - (motorRightPower-robotYawSpeed))+1;
